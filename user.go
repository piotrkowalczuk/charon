...
func (ue *userEntity) Message() (*User, error) {
	var (
		err                  error
...
type userProvider interface {
	...
	SetPermissions(id int64, permissions ...Permission) (int64, int64, error)
}
...
func (ur *userRepository) IsGranted(id int64, p Permission) (bool, error) {
	var exists bool
...
func (ur *userRepository) SetPermissions(id int64, p ...Permission) (int64, int64, error) {
...
func createDumyTestUser(repo userProvider, hasher PasswordHasher) (*userEntity, error) {
